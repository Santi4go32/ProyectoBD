...
const typeuserRouter = require('./routes/typeuser');
const creartrabajadorRouter = require('./routes/creartrabajador');
...
app.use('/typeuser', typeuserRouter);
app.use('/creartrabajador',creartrabajadorRouter);
